package com.lxcecho.spring.aop.support;

import com.lxcecho.spring.aop.aspect.EchoAfterReturningAdviceInterceptor;
import com.lxcecho.spring.aop.aspect.EchoAspectJAfterThrowingAdvice;
import com.lxcecho.spring.aop.aspect.EchoMethodBeforeAdviceInterceptor;
...
//                        advices.put("before",new EchoAdvice(,));
						advices.add(new EchoMethodBeforeAdviceInterceptor(aspectClass.getConstructor().newInstance(),
...
//                        advices.put("after",new EchoAdvice(aspectClass.newInstance(),aspectMethods.get(config.getAspectAfter())));
						advices.add(new EchoAfterReturningAdviceInterceptor(aspectClass.getConstructor().newInstance(),
...
//                        EchoAdvice advice = new EchoAdvice(aspectClass.newInstance(),aspectMethods.get(config.getAspectAfterThrow()));
						EchoAspectJAfterThrowingAdvice advice = new EchoAspectJAfterThrowingAdvice(aspectClass.getConstructor().newInstance(),
